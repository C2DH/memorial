    ...
    <div {...rest}>
      <a href="https://www.c2dh.uni.lu" target="_blank" rel="noopener noreferrer">
        <svg height={height} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 219.68 57.12">
          ...
          />
          <rect fill={color} x="29.71" y="38.24" width="0.77" height="5.64" />
          <path
            fill={color}
          ...
          />
          <rect fill={color} x="51.5" y="38.24" width="0.77" height="5.64" />
          <polyline
            fill={color}
          ...
          />
          <rect fill={color} x="17.19" y="33.66" width="59.3" height="0.81" />
          <polyline
            fill={color}
          ...
          />
          <rect fill={color} x="176.4" y="18.13" width="5.47" height="5.47" />
          <rect fill={color} x="185.28" y="26.65" width="5.47" height="5.47" />
          <rect fill={color} x="179.96" y="10.14" width="5.47" height="5.47" />
          <rect fill={color} x="153.09" y="9.57" width="5.47" height="5.47" />
          <rect fill={color} x="166.9" y="7.27" width="5.47" height="5.47" />
          <rect fill={color} x="176.59" y="30.35" width="5.47" height="5.47" />
          <rect fill={color} x="139.82" y="3.73" width="5.47" height="5.47" />
          <path
            fill={color}
